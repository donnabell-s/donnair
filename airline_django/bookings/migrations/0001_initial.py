    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ArrivalAirport', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='arrivals', to='bookings.airport')),
                ('DepartureAirport', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='departures', to='bookings.airport')),
            ],
        ),
        migrations.CreateModel(
            name='Booking',
